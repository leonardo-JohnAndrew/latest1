    ...
    <a href="adminbarrowed.php" id ="btn" >Barrowed List</a>
     <div class= "mt-3"  style="max-height:500px;overflow-y:scroll">
       <table class="table table-striped "  >
         ...
         <tbody>
         <?php 
           $sqlaccounts ="SELECT * from unit_request  where remarks is null or unit_code = '' order by No desc";
         ...
         ?>
           ...
           <td><input type="text" class="no" value="<?php  echo $rows['No'] ?>" size="3px" readonly></td>
            <td><input type="text" name="class_" value="<?php  echo $rows['classification'] ?>" size= "10px" readonly></td>
